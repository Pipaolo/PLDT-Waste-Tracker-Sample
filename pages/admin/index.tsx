    ...
    <PrivateContainer className="flex flex-col bg-black md:h-screen ">
      ...
      <Container className="flex w-full gap-2 p-2">
        ...
        <div className="flex flex-col justify-between w-full gap-2">
          ...
          <Container className="flex flex-wrap gap-4 overflow-y-scroll overflow-x-hidden"> 
            <div className=" h-32 w-64 bg-white border-2 border-gray-200 rounded-lg flex justify-center items-center ">Sample Content</div>
